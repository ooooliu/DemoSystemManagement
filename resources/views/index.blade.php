...
<body class="main_body">
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-main">
			    ...
			    <ul class="layui-nav top_menu">
			    	...
			    	<li class="layui-nav-item" mobile>
			    		<a href="javascript:;" data-url="/page/user/changePwd"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>设置</cite></a>
			    	</li>
			    	<li class="layui-nav-item" mobile>
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				...
				<p>你好！<span class="userName">Lyn</span>, 欢迎登录</p>
			</div>
		...
		<div class="layui-footer footer">
			<p>copyright © 2017.12.06 Develop By Lyn</p>
		</div>
	</div>
	...
	<div class="admin-header-lock" id="lock-box" style="display: none;">
		...
		<div class="admin-header-lock-name" id="lockUserName">Lyn</div>
		<div class="input_btn">
